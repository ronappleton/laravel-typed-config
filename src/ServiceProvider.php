...
class ServiceProvider extends BaseServiceProvider
{
    ...
    {
        Repository::macro('string', fn (string $key, ?string $default = null) => $config->string($key, $default));
        ...
        Repository::macro('classString',
            function (string $key, ?string $default = null) use ($config): string {
                /** @var class-string $default */
                return $config->classString($key, $default);
            }
        );
    }
}
